...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.place'
        db.add_column('pybb_topic', 'place',
                      self.gf('django.contrib.gis.db.models.fields.GeometryField')(default='POINT (0 0)'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.place'
        db.delete_column('pybb_topic', 'place')
