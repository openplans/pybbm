...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WatchArea'
        db.create_table('pybb_watcharea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('fence', self.gf('django.contrib.gis.db.models.fields.GeometryField')()),
        ...
        db.send_create_signal('pybb', ['WatchArea'])

        # Adding M2M table for field watchers on 'WatchArea'
        db.create_table('pybb_watcharea_watchers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('watcharea', models.ForeignKey(orm['pybb.watcharea'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('pybb_watcharea_watchers', ['watcharea_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'WatchArea'
        db.delete_table('pybb_watcharea')

        # Removing M2M table for field watchers on 'WatchArea'
        db.delete_table('pybb_watcharea_watchers')
    ...
    models = {
        ...
        'pybb.topic': {
            ...
            'on_moderation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'place': ('django.contrib.gis.db.models.fields.GeometryField', [], {}),
        ...
        'pybb.watcharea': {
            'Meta': {'ordering': "['-created']", 'object_name': 'WatchArea'},
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'fence': ('django.contrib.gis.db.models.fields.GeometryField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'watchers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'areas'", 'symmetrical': 'False', 'to': "orm['auth.User']"})
        }
    }
